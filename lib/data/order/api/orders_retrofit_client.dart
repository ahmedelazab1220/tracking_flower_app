...
abstract class OrdersRetrofitClient {
  ...
  Future<OrderDto> getOrders(String ordersIt);

  @GET(ApiConstants.orders)
  Future<OrderItemDto> getOrderItem(@Query('productId') String productId);

  @GET(ApiConstants.orders)
  Future<StoreDto> getStore(@Query('storeId') String storeId);

  @GET(ApiConstants.orders)
  Future<UserDto> getUser(@Query('userId') String userId);
}
