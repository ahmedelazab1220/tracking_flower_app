...
class _OrdersRetrofitClient implements OrdersRetrofitClient {
  _OrdersRetrofitClient(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  Future<OrderItemDto> getOrderItem(String orderItemId) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late OrderItemDto _value;
    try {
      _value = OrderItemDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<StoreDto> getStore(String storeId) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late StoreDto _value;
    try {
      _value = StoreDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
